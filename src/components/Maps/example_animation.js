...
class WalkRoute extends Component {
  componentDidMount() {
    ...
    //add to dom
    map = L.map('walkroute', {zoomControl: false})
      .addLayer(KartoLayer)
      .setView([42.3575, -71.0635], 15); //position & zoomlevel
    ...
    //add svg container to map as a whole
    ...
    d3.json("http://localhost:3090/walk/4", function(collection) {
        ...
        var featuresdata = collection.features.filter(function(d) {
            return d.properties.pt_type == "feature"
        })
        ...
        function transition() {
            linePath.transition()
                ...
                .each("end", function() {
                    // d3.select(this).call(transition);// infinite loop doesn;t work
                }); 
        } //end transition
