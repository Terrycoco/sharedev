...
function validateRSAA(action) {
  ...
  var validCallAPIKeys = ['endpoint', 'options', 'method', 'body', 'headers', 'credentials', 'bailout', 'types', 'cache'];
  var validMethods = ['GET', 'HEAD', 'POST', 'PUT', 'PATCH', 'DELETE', 'OPTIONS'];
  var validCredentials = ['omit', 'same-origin', 'include'];
  var requiredCacheFunctions = ['has', 'get', 'set'];
  ...
  if (cache != null) {
    if (!requiredCacheFunctions.every(function (f) {
      return typeof cache[f] === 'function';
    })) {
