...
var _CardExpandable2 = __webpack_require__(455);
...
var _StopItem = __webpack_require__(484);
  ...
  _createClass(StopList, [{
    ...
    value: function renderItems() {
      ...
      if (this.props.stops.length == 0) {
        ...
        items = this.props.stops.map(function (stop, idx) {
...
var _Card = __webpack_require__(457);
...
var styles = {
  selectedCard: {
    background: _theme.theme.secondaryColor
  },
  card: {
    background: 'white'
  },
...
var StopItem = function (_Component) {
  ...
  function StopItem(props) {
    ...
    _this.getStopHandler = _this.getStopHandler.bind(_this);
    return _this;
  }

  _createClass(StopItem, [{
    key: 'getStopHandler',
    value: function getStopHandler(stopIdx) {
      var saveStop = this.props.saveStopIdx;
      var handleAccept = function handleAccept(event) {
        saveStop(stopIdx);
      };
      return handleAccept;
    }
    ...
    key: 'render',
    value: function render() {
      var cardstyle = this.props.idx == this.props.selectedStopIdx ? styles.selectedCard : styles.card;

      return _react2.default.createElement(
        _Card.Card,
        { onClick: this.getStopHandler(this.props.idx), style: cardstyle },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, actions)(StopItem);
...
var greenIcon = L.icon({
  iconUrl: __webpack_require__(549),
...
var SnakeMap = function (_Component) {
  ...
  function SnakeMap(props) {
    ...
    _this.updateStops = _this.updateStops.bind(_this);
    _this.highlightCurrentStop = _this.highlightCurrentStop.bind(_this);
    return _this;
  }
  ...
  _createClass(SnakeMap, [{
    ...
    key: 'highlightCurrentStop',
    value: function highlightCurrentStop() {
      if (this.props.stops.length > 0) {
        currentLayer.clearLayers();
        var stop = this.props.stops[this.props.selectedStopIdx];
        var marker = L.marker([stop.lat, stop.lng], { icon: greenIcon }).addTo(currentLayer);
...
var _makeSelectable2 = __webpack_require__(545);
...
var _SnakeMap = __webpack_require__(503);
...
var _StopList = __webpack_require__(460);
